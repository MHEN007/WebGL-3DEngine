class Shulker{
    ...
    constructor() {
        ...
        this.topFrontLeftMesh = new Mesh(this.#topFrontLeftGeometry, this.#materials, [0, 0, 0, 0, 0, 0])
        ...
        this.topFrontRightMesh = new Mesh(this.#topFrontRightGeometry, this.#materials, [0, 0, 0, 0, 0, 0])
        ...
        this.botFrontMesh = new Mesh(this.#botFrontGeometry, this.#materials, [7, 7, 7, 7, 7, 7])
        ...
        this.topFrontRightMesh = new Mesh(this.topFrontRightMesh, this.#materials, [0, 0, 0, 0, 0, 0])

        // BACK
        this.topBackMesh = new Mesh(this.#topBackGeometry, this.#materials, [0, 0, 0, 0, 0, 0])
        ...
        this.topBackLeftMesh = new Mesh(this.#topBackLeftGeometry, this.#materials, [0, 0, 0, 0, 0, 0])
        ...
        this.topBackRightMesh = new Mesh(this.#topBackRightGeometry, this.#materials, [0, 0, 0, 0, 0, 0])
        ...
        this.botBackMesh = new Mesh(this.#botBackGeometry, this.#materials, [7, 7, 7, 7, 7, 7])
        ...
        this.topBackRightMesh = new Mesh(this.topBackRightMesh, this.#materials, [0, 0, 0, 0, 0, 0])

        // RIGHT
        this.topRightMesh = new Mesh(this.#topRightGeometry, this.#materials, [0, 0, 0, 0, 0, 0])
        ...
        this.topRightLeftMesh = new Mesh(this.#topRightLeftGeometry, this.#materials, [0, 0, 0, 0, 0, 0])
        ...
        this.topRightRightMesh = new Mesh(this.#topRightRightGeometry, this.#materials, [0, 0, 0, 0, 0, 0])
        ...
        this.botRightMesh = new Mesh(this.#botRightGeometry, this.#materials, [7, 7, 7, 7, 7, 7])
        ...
        // KIRI
        this.topLeftMesh = new Mesh(this.#topLeftGeometry, this.#materials, [0, 0, 0, 0, 0, 0])
        ...
        this.topLeftLeftMesh = new Mesh(this.#topLeftLeftGeometry, this.#materials, [0, 0, 0, 0, 0, 0])
        ...
        this.topLeftRightMesh = new Mesh(this.#topLeftRightGeometry, this.#materials, [0, 0, 0, 0, 0, 0])
        ...
        this.botLeftMesh = new Mesh(this.#botLeftGeometry, this.#materials, [7, 7, 7, 7, 7, 7])
